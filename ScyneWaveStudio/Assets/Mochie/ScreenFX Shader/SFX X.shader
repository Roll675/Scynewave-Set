...
Shader "Mochie/Screen FX/Screen FX X" {
    Properties {
    ...
    SubShader {
		...
		Pass {
			...
			#pragma shader_feature PIXELSNAP_ON				// Triplanar
			#pragma shader_feature _FADING_ON				// Fog
			#define TRIPLANAR
			#define SFXX
        ...
        Pass {
			...
			#pragma shader_feature _COLORADDSUBDIFF_ON		// Outline
			#define MAIN
			#define SFXX
			#include "SFXDefines.cginc"
			#pragma target 5.0
